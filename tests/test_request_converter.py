...
from tests.conftest import make_request, mock_model_manager
...
class TestConvertClaudeToOpenAI:
    ...
    def test_basic_message_with_string_system(self):
        ...
        result, ws = convert_claude_to_openai(req, mock_model_manager())
        assert ws is None
    ...
    def test_system_prompt_as_list_of_text_blocks(self):
        ...
        result, _ = convert_claude_to_openai(req, mock_model_manager())
    ...
    def test_max_tokens_clamped(self):
        ...
        req = make_request(max_tokens=50)
        result, _ = convert_claude_to_openai(req, mock_model_manager())
